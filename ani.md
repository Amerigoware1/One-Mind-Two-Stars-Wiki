...
Initially deployed during the height of the mid-2247 communication surge to aid the expanding [Listener Corps]({{ '/listener-corps.html' | relative_url }}), the hardware footprint expanded rapidly across all four river outposts. By automating language translation and data tracking, the A.N.I. reached an active infrastructure of over 200 certified devices by 2255.
