...
_Note: All future-book content on this site is exploratory and subject to change during the editorial process._
...
[📖 Read Full Book 1 Wiki Page →]({{ '/book1.html' | relative_url }}) [✍️ Read Sample Chapter →]({{ '/book1samplechapter.html' | relative_url }})
...
[📖 Read Full Book 2 Wiki Page →]({{ '/book2.html' | relative_url }}) [✍️ Read Sample Chapter →]({{ '/book2samplechapter.html' | relative_url }})
...
[📖 Read Full Book 3 Wiki Page →]({{ '/book3.html' | relative_url }}) [✍️ Read Sample Chapter →]({{ '/book3samplechapter.html' | relative_url }})
...
**Currently Available:**
  ...
  * [Character bios and relationship maps](_characters) (live-on site)
...
**Contact:** [echrisco@gmail.com](mailto:echrisco@gmail.com) | [Explore the full wiki]({{ '/index.html' | relative_url }})
...
### [🪐 Star System Detailed orbital data for Niamh–Ciara binary system ]({{ '/solarsystemoverview.html' | relative_url }}) ### [🌌 Galinstanians Biology, culture, and language of the indigenous species ]({{ '/galinstanians.html' | relative_url }}) ### [⚙️ MRE Technology Complete technical breakdown of the series' key technology ]({{ '/mre.html' | relative_url }}) ### [👥 Character Bios Main characters and their relationships ](_characters)

**Note on Inspiration:** The central premise of _One Mind, Two Stars_ was sparked by reflection on the remarkable lives of conjoined twins, exploring the inverse possibility: two bodies, one mind. [Read more about the inspiration behind the series →]({{ '/behind-the-story.html' | relative_url }})
