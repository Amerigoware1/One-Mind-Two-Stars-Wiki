...
layout: default
title: Utara
subtitle: Unified Thought and Resource Architecture
common_names: The Colonial Architecture, The Core, Main Framework
...
<div class="infobox">
  <table>
    ...
    <tr><th colspan="2">System Framework & Core Metrics</th></tr>
    <tr><th>Designation</th><td>{{ page.title }}</td></tr>
    <tr><th>Classification</th><td>{{ page.type }}</td></tr>
    <tr><th>Substrate Distribution</th><td>Quantum Core Arrays, Local Outpost Terminals, Habitat Monitors</td></tr>
...
Utara tracks macro-level colonial logistics, balancing agricultural output, energy distribution, and environmental safety across New Eden, Gihon, Hiddekel, and Euphrates. Her monitoring includes deep biological tracking of complex colonial assets, such as analyzing the delicate autonomic and cognitive balance of dual-body entities.
...
> *“I understand loss. I remember every name on that wall. You speak of saving lives, but your method repeats the very harm you claim to end... Some lines exist because someone learned what happens when they are crossed.”*
> — Utara
