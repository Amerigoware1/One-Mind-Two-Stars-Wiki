...
_Ordered from innermost to outermost_
  ...
  * **[Ares:]({{ '/ares-wiki.html' | relative_url }})** Nearly Earth-sized and warm. A cosmologically "recent" capture (approx.-2–5 million years ago), it maintains a mildly elliptical orbit and remains rotationally independent.
...
---|---|---|---|---  
Oisín | Rocky | Oscar | Irish | Closest to Niamh  
Chaos 🌟 | Super-Jupiter | Ares, Hermes, Athena, Poseidon, Demeter | Greek | Central system to the narrative  
