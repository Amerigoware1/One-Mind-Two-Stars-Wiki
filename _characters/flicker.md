...
portrait: "{{ '/assets/images/flicker-book2.webp' | relative_url }}"

portrait-book2: "{{ '/assets/images/flicker-book2.webp' | relative_url }}"

portrait-book3: "{{ '/assets/images/flicker-book3.webp' | relative_url }}"

portrait-book4: "{{ '/assets/images/flicker-book4.webp' | relative_url }}"

portrait-book5: "{{ '/assets/images/flicker-book5.webp' | relative_url }}"
...
book2_arc: >
  ...
  The rescue and cave-in follow. Flicker works alongside the other Galinstanians to dissolve stone, channeling their natural speed into rapid, precise dissolution. After the escape, Flicker emerges as the most curious of the cluster—eager to explore this new world of humans, despite the trauma.

  During the celebration, Flicker meets the human twins Emma and Ethan. Fascinated by their similarities and differences—"same origin, different development"—Flicker flows between them repeatedly, trying to understand the pattern. When the naming ceremony comes, Emma and Ethan together perceive Flicker's quick, bright presence and name them "Flicker"—"like light that moves."

  The twins share Flicker's bond, a unique arrangement that delights Flicker. They become the fastest of the human–Galinstanian connections, with Flicker zipping between Emma and Ethan as if trying to be in two places at once—much like the twins themselves.
