...
book1_age: "42.9 Earth / 38.5 Ares"
book2_age: "49.8 Earth / 44.7 Ares"
book3_age: "49.8 Earth / 44.7 Ares"
book4_age: "58.0 Earth / 52.1 Ares"
book5_age: "65.0 Earth / 58.4 Ares"
---
...
Zoë is compact, strong, and expressive, with warm eyes and a steady presence. Her voice carries a practiced calm that can cut through panic without raising volume. Age brings silver streaks to her hair and deeper lines around her eyes, but her posture remains upright and purposeful.
...
## Relationships
- **Amerigo Carisco** — husband, intellectual partner  
- **Celectra Carisco** — daughter, source of pride and worry  
- **Xan Carisco** — son, her “little engineer”  
- **Jenni Jo & Xara Zo** — granddaughters, the center of her later life  
- **Jaxon Bowers** — son‑in‑law in all but name  
- **Stan, Chime, Ripple** — Galinstanians she learns to understand through Celectra  
- **Alex & Dee Cruiz** — long‑time friends and colleagues  

## Story Overview (Non-Spoiler)
Zoë’s journey is one of resilience and adaptation. She raises a traumatized dual‑bodied child with no precedent, helps build the psychological frameworks that allow human–Galinstanian coexistence, and becomes a grandmother whose wisdom shapes the next generation. Her arc is about choosing compassion even when the universe offers no guidebook.
...
<div class="tab-container">
  ...
  <div id="book1" class="tab-content">
    <h2>Book 1 — The Mother of a Miracle</h2>
  ...
  <div id="book3" class="tab-content">
    <h2>Book 3 — The Weight of Legacy</h2>
  ...
  <div id="book5" class="tab-content">
    <h2>Book 5 — Wisdom of the Elder</h2>
