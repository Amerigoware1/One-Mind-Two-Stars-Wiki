...
portrait: "{{ '//assets/images/guardian-book2.webp' | relative_url }}"

portrait-book2: "{{ '//assets/images/guardian-book2.webp' | relative_url }}"

portrait-book3: "{{ '//assets/images/guardian-book3.webp' | relative_url }}"

portrait-book4: "{{ '//assets/images/guardian-book4.webp' | relative_url }}"

portrait-book5: "{{ '//assets/images/guardian-book5.webp' | relative_url }}"
...
book2_arc: >
  ...
  The rescue comes: Celectra's team captures Kret, but he triggers a cave-in. Guardian works alongside the other Galinstanians to dissolve stone, channeling parental fury into precise, desperate dissolution. After the escape, Guardian's first act is to flow to Chime, wrapping around them in protective stillness.

  During the celebration, Hiro—a child with particular reverence for other people's parents—approaches Guardian. Perceiving their warm, protective presence, Hiro names them "Guardian." The name resonates deeply: Guardian has always been protective, but now that protection extends to all the children of both species.
