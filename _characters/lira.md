...
layout: character
title: Lira Keahi
portrait: "{{ '//assets/images/lira-book5.webp' | relative_url }}"

portrait-book1: "{{ '//assets/images/lira-book1.webp' | relative_url }}"

portrait-book2: "{{ '//assets/images/lira-book2.webp' | relative_url }}"

portrait-book3: "{{ '//assets/images/lira-book3.webp' | relative_url }}"

portrait-book4: "{{ '//assets/images/lira-book4.webp' | relative_url }}"

portrait-book5: "{{ '//assets/images/lira-book5.webp' | relative_url }}"
...
book1_arc: >
  ...
  She doesn't intervene, doesn't advise, simply *observes*. This early exposure plants the seed of her later interest in child psychology and her deep, protective connection to the Carisco family.

book2_title: "Zoë's Intern"
book2_arc: >
  By Book 2, Lira has completed her psychology training and serves as Dr. Zoë Carisco's intern. She attends Council meetings, takes notes, and watches Celectra's growing burnout with professional concern.

  **Chapter 5 — Ambassador's Burden:** Lira observes Celectra's ineffective mediation with Councilor Webb and notes her exhaustion. After the meeting, she approaches Celectra with a gentle observation: "The bridge could use some piers." This seeds the idea of the Listener Corps—peers who can share the weight.

  **Chapter 9 — Expanding the Circle:** Lira helps facilitate the first Listener Corps training sessions, working alongside Celectra, Jaxon, Ananya, and Maya. Her role is subtle but essential: she notices who struggles, who needs encouragement, and when Celectra is pushing too hard.

  Throughout the northern rescue arc, Lira remains in New Eden coordinating with Ananya, providing psychological triage from a distance, and preparing to support Celectra upon her return. She becomes one of the few people Celectra trusts to say "I'm tired" without translation.

book3_title: "Steady Presence"
book3_arc: >
  Lira's role expands as the Listener Corps grows. She trains new members, helps develop psychological protocols for human–Galinstanian interaction, and quietly supports Celectra through pregnancy, research guilt, and the transition from sole bridge to network architect.

  **Supporting Role:** Lira is present at key moments—the twins' birth, Maya's exhibitions, Celectra's wedding—not as a central figure but as the person who ensures everyone is functioning. She notices when Zoë is running on empty, when Ananya is burning out, when Maya needs her sister's quiet presence.

  **Professional Growth:** By the end of Book 3, Lira has become the colony's informal expert on child development in cross-species contexts. She documents how children raised alongside Galinstanians process identity, empathy, and communication differently—work that will prove essential in later years.

book4_title: "The Mentor"
book4_arc: >
  In Book 4, Lira leads the Four Rivers Exchange Program, taking small groups of children—including eight-year-old twins Jenni and Xara—to the four river settlements. Her calm, observant style makes her the ideal guide for young people encountering the bismuth network's mysteries.

  **Chapter 7 — Gihon's Green Surprise:** Lira leads the first trip, allowing Jenni's curiosity and Xara's analytical mind to explore while ensuring their safety. When Ripple shows signs of distress, she doesn't panic—she observes, documents, and trusts the twins to communicate what they're sensing.

  **Chapter 11 — The Hum at Hiddekel:** When Ripple becomes dizzy from the geothermal interference, Lira immediately calls for a rest break, prioritizing the Galinstanian child's wellbeing over the schedule. Her quiet competence creates safety without drama.
...
book5_arc: >
  Now in her mid-forties, Lira has become an institution—not through loud advocacy, but through decades of consistent, thoughtful presence. She serves as a consultant for youth programs, advises on psychological aspects of ANI integration, and remains a trusted mentor to the twins, now fourteen.

  **Chapter 1 — The Ordinary Day:** Lira is mentioned as co-director of the Samaya Gallery alongside Maya, though her role is more advisory than operational—she ensures the educational programs serve children's developmental needs.

  **Chapter 3 — The Interview:** Lira is present in the background as Xara passes Kael's house, observing how the younger generation navigates acoustic communication. She doesn't intervene—she trusts what she helped build.
...
- calm under pressure
- perceptive and patient
- protective without being overbearing
- skilled at creating safety without demanding vulnerability
- natural mentor who leads by presence rather than instruction
