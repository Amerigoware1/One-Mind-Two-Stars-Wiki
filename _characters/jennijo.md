...
portrait: "{{ '/assets/images/jennijo-book5.webp' | relative_url }}"

portrait-book3: "{{ '/assets/images/jennijo-book3.webp' | relative_url }}"

portrait-book4: "{{ '/assets/images/jennijo-book4.webp' | relative_url }}"

portrait-book5: "{{ '/assets/images/jennijo-book5.webp' | relative_url }}"
...
- instinctive resonance sensitivity
- warmth and openness
- a protective streak toward Ripple
- a tendency to "feel first, think second"

Her strengths include:

- early detection of emotional-harmonic shifts
- calming pulses during resonance instability
- intuitive understanding of Galinstanian fields
- strong interpersonal bonds

Her weaknesses include:

- tendency to prioritize emotion over analysis
...
- **Celectra & Jaxon** — parents; Jenni's sensitivity mirrors Celectra's while her steadiness comes from Jaxon
- **Zoë & Amerigo** — grandparents; Zoë nurtures her emotional intelligence, Amerigo her curiosity
