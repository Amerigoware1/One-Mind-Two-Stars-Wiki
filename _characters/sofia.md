...
layout: character
title: Sofia Patel
portrait: "{{ '/assets/images/sofia-book5.webp' | relative_url }}"

portrait-book2: "{{ '/assets/images/sofia-book2.webp' | relative_url }}"

portrait-book3: "{{ '/assets/images/sofia-book3.webp' | relative_url }}"

portrait-book4: "{{ '/assets/images/sofia-book4.webp' | relative_url }}"

portrait-book5: "{{ '/assets/images/sofia-book5.webp' | relative_url }}"
...
- instinct to provide safety and comfort
- calm presence in crisis situations
- lifelong bond with Harbor, whom she named for safety
- commitment to medical and emotional care

Her strengths include:
- medical assessment and patient care
- emotional support and de-escalation
- working with Galinstanians on health matters
