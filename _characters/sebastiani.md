...
portrait: "{{ '/assets/images/sebastiani-book1.jpg' | relative_url }}"

portrait-book1: "{{ '/assets/images/sebastiani-book1.jpg' | relative_url }}"

portrait-book2: "{{ '/assets/images/sebastiani-book2.jpg' | relative_url }}"

portrait-book3: "{{ '/assets/images/sebastiani-book3.jpg' | relative_url }}"

portrait-book4: "{{ '/assets/images/sebastiani-book4.jpg' | relative_url }}"

portrait-book5: "{{ '/assets/images/sebastiani-book5.jpg' | relative_url }}"
...
book2_title: "Coexistence Under Load"
book2_arc: >
  By 2239, Sebastiani's role expands from warning about the unknown to helping the colony survive alongside it. She becomes essential in mapping safe mining zones, redesigning power systems for subterranean proximity, and building early-warning protocols for anomalies in colony infrastructure. Her expertise proves that skepticism can become service when it is turned toward preparation rather than obstruction. The story tests whether her caution was wisdom, fear, or both, and whether a person built for crisis can learn to live with uncertainty without losing herself.

book3_title: "Redundancy and Trust"
book3_arc: >
  In 2246, Sebastiani is no longer merely the harsh voice in the chamber; she is one of the colony's most important stabilizers. Her insistence on redundancy, inspection, and accountability keeps critical systems steady during a period of political and technological strain. She finds common ground with colleagues who once dismissed her, especially when the colony must balance idealism with operational reality. Her arc deepens here as she learns that trust is not the opposite of caution, but something that must be engineered just as carefully as any grid or conduit.

book4_title: "The System Holds"
book4_arc: >
  By 2255, Sebastiani has become one of the older stateswomen of the colony's technical leadership. She is less inclined to argue for argument's sake and more focused on making sure that the structures she built still protect the people relying on them. In this period, her authority comes not from dramatic speeches but from the fact that her systems continue to work when stress arrives. The colony's survival depends on people like her: those who see failure modes before others see headlines. Her story in Book 4 is about the quiet dignity of competence.

book5_title: "Legacy of Caution"
book5_arc: >
  In 2262, Sebastiani stands as a veteran of the colony's hardest years, now recognized for the stability her caution preserved. What once made her difficult to like has become part of her authority: she was right to ask uncomfortable questions, because the answers kept people alive. Her legacy is visible in every redundant circuit, every emergency protocol, and every planner who learned to treat skepticism as a form of care. She remains a reminder that survival is often built by the people who insist on checking everything twice.
---
...
- **The Warning (book-1):** Tells Amerigo that when the Galinstanians turn on them, she hopes he remembers her warning.
- **Infrastructure Planning (book-2):** Helps design safe mining zones and power systems that account for subterranean neighbors.
- **Emergency Protocols (book-2):** Develops early-warning systems for infrastructure anomalies.
...
> "Self-preservation is not benevolence."

> "When those things turn on us—and they will—I hope you'll remember I said so."
...
- She refuses to use wireless communication for critical systems.
