...
book2_arc: >
  ...
  The rescue follows: Celectra's team captures Kret, but he triggers a cave-in. Spark works alongside the other Galinstanians to dissolve stone from within while humans dig from without. After the escape, Spark emerges as the most lighthearted of the cluster—a deliberate choice to counter the darkness they all survived.

  During the celebration, Spark meets Zuri, a child with an infectious giggle. Zuri perceives Spark's playful, curious presence and names them "Spark"—"Because they make everything feel more fun." The name fits perfectly. Spark and Zuri bond over shared delight in exploration, laughter, and finding joy in small things.
...
## Overview
Spark is a member of the Northern Territory Galinstanian cluster, named by Zuri during the rescue celebration in Book 2. Zuri, giggling as Spark attempted to replicate the shape of a human face, chose "Spark" because Spark "makes everything feel more fun." The name captured Spark's essence: playful, curious, bright—the one who finds joy even in darkness.

During Chime's torture, Spark was forced into terrified stillness, their natural lightness crushed by helplessness. After the rescue, Spark made a conscious choice: to become the joy keeper. Not to deny the trauma, but to insist that darkness does not get the final word.
</div>
...
- cheering up distressed beings of any species
- making complex ideas approachable through play
- noticing small delights that others overlook
- helping traumatized beings rediscover joy
- defusing tension with well-timed humor

Their weaknesses include:

- sometimes uses humor to avoid processing difficult emotions
- can seem frivolous to those who don't know their history
- deeply affected when their joy is rejected
- carries hidden grief about Chime's torture
</div>
...
<div class="card-bg" markdown="1">
### Galinstanian Wisdom
- **On Joy:** "Darkness does not get the final word. I refuse to give it that power."
- **On Humor:** "Laughter is not the opposite of grief. It is grief's companion."
- **On Hiding:** "I hid because I was afraid. Now I shine because I am still here."
- **On Play:** "Serious problems do not require serious faces. They require serious hearts. My face can be silly."
- **On Fun:** "Making everything feel more fun is not escape. It is insistence that life continues."
</div>

<div class="card-bg" markdown="1">
### Themes
- **Joy as Defiance:** Choosing lightness in the face of darkness is an act of courage
- **Humor as Healing:** Laughter can be a bridge across trauma
- **Play as Serious Business:** Fun is not frivolous; it is survival
- **The Courage to Be Bright:** It is harder to shine after suffering than to dim
- **Shared Delight:** Joy multiplies when shared across species
</div>

<div class="card-bg" markdown="1">
### Trivia
- Spark's name came from Zuri's childhood giggle; Zuri said Spark "sparkles" even without light
- Spark can imitate human facial expressions in pseudopod form—badly, and deliberately so
- They have a private resonance pattern that only Zuri can trigger, a kind of secret handshake in pulse form
- Spark still has nightmares about Chime's torture but wakes themselves by pulsing a bright, silly rhythm
- The other Northern Cluster members come to Spark when they need to remember why survival matters
- Spark once made Celectra laugh so hard her two bodies giggled out of sync
- They maintain a mental catalog of "things that are funny to both species"—it is surprisingly long
</div>
