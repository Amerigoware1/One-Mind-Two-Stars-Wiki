...
portrait-book3: "/assets/images/stan-book3.webp"
...
book1_arc: >
  ...
  Stan begins the long work of translation—not just of language, but of two species learning to perceive each other. His patience and Celectra's unique bridge create the first true cross-species communication.

book2_title: "The Northern Territory"
book2_arc: >
  Stan plays a crucial role in the Northern Territory expedition, guiding Celectra and the human team through Galinstanian territory. When the team discovers Dr. Kret's captive Galinstanians, Stan helps Chime and the others process their trauma and begin the long journey toward healing.

  His presence anchors the rescue operation, and he advocates for the establishment of the Listener Corps as a formal bridge between species. Stan recognizes that Celectra cannot carry the weight alone and supports the training of human listeners who can share the burden.

book3_title: "The Communion Interface"
book3_arc: >
  As the Communion Interface project accelerates, Stan serves as a cultural consultant, helping engineers understand which aspects of Galinstanian communication can be translated into technology and which resist capture. He supports Celectra through her pregnancy, offering wisdom about generational continuity from a species that measures time in centuries.

  When debates arise about using Dr. Kret's confiscated research, Stan offers a Galinstanian perspective: knowledge gained through harm carries the harm within it. His counsel helps shape the ethical framework for the Interface.

book4_title: "The Four Rivers Resonance"
book4_arc: >
  During the Four Rivers crisis, Stan works alongside Amerigo, the twins, and Ripple to understand the disturbances in the bismuth network. His centuries of experience help contextualize the anomalies, recognizing patterns that younger Galinstanians have never witnessed.

  He guides Ripple through their first encounter with large-scale resonance instability, providing the steady presence of an elder. When the Great Resonance stabilizes the network, Stan pulses with quiet satisfaction: the work of generations continues.

book5_title: "Elder and Witness"
book5_arc: >
...
- patient wisdom accumulated over centuries
- profound acceptance of others' perceptions
- quiet authority that guides without commanding
- deep understanding of Galinstanian collective memory
- protective instinct toward the young—both human and Galinstanian

His strengths include:

- cross-species translation and cultural interpretation
- knowledge of Galinstanian history and resonance patterns
- steadying presence during crises
- mentoring younger generations
- bridging the gap between human urgency and Galinstanian patience
...
- **Ripple** — mentor and guide; Stan recognizes in Ripple the same potential he once saw in Celectra
