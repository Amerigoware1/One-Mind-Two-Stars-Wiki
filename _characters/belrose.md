...
portrait: "{{ '/assets/img/portraits/belrose-book1.jpg' | relative_url }}"

portrait-book1: "{{ '/assets/images/belrose-book1.webp' | relative_url }}"

portrait-book2: "{{ '/assets/images/belrose-book2.webp' | relative_url }}"

portrait-book3: "{{ '/assets/images/belrose-book3.webp' | relative_url }}"

portrait-book4: "{{ '/assets/images/belrose-book4.webp' | relative_url }}"

portrait-book5: "{{ '/assets/images/belrose-book5.webp' | relative_url }}"

affiliation: New Eden Colony Cultural Affairs & Community Relations Division; Council Member
status: Alive
...
book1_arc: >
  Belrose appears in council sessions as a thoughtful observer who speaks primarily when discussion turns to community impact. During the Galinstanian disclosure:

  - She listens intently to Celectra's descriptions of Galinstanian consciousness, recognizing the profound implications for human self-understanding
  - She raises concerns about how the revelation will affect colony morale and identity
  - She abstains from the final vote, arguing that the community needs time to process before committing to formal protocols

  After the session, she begins organizing informal gatherings where colonists can discuss their feelings about the revelation—creating space for the emotional work that official channels don't address.

book2_title: ""
book2_arc: >
  Belrose's role expands as the colony grapples with the psychological and cultural implications of coexistence. Her initiatives include:

  - Establishing the "Samaya Gallery" (named after Celectra's Galinstanian friend), a space dedicated to interspecies understanding
  - Developing educational programs that prepare children for a world shared with Galinstanians
  - Creating rituals and ceremonies that acknowledge the historic nature of first contact
  - Facilitating dialogue sessions where colonists can process fear, wonder, and uncertainty
...
**Empathic Diplomacy:** Unlike political negotiators who seek compromise, she seeks understanding. Her goal isn't agreement—it's connection.
...
- Speaks six languages and is studying Galinstanian electromagnetic patterns as an aesthetic form
