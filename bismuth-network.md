---
layout: default
title: The Bismuth Network
subtitle: Natural Subterranean Waveguides & Biologically Plated Memory Veins
common_names: Memory Veins, The Waveguides, Lithic Grooves
origin: Galinstanian Biomineralization (Millennia-scale)
composition: Bismuth crystals, Crystalline Granite, Native Metals
function: Planetary Resonance Propagation & Memory Storage
depth: Surface outcroppings down to 2+ kilometers below New Eden
protocol: Sympathetic Electromagnetic Remanence (Non-linguistic)
---
...
<div class="infobox">
  <table>
    ...
    <tr><th colspan="2">Geological & Harmonic Specifications</th></tr>
    ...
    <tr><th>Depth Range</th><td>{{ page.depth }}</td></tr>
    <tr><th>Recording Protocol</th><td>{{ page.protocol }}</td></tr>
  </table>
...
Discovered deep beneath the center of New Eden, the accessibility of the Great Resonance archive poses profound philosophical and ethical questions for the colony. Because the entirety of native history since the Great Resonance is physically recorded in the stone beneath human settlements, the [Listener Corps]({{ '/listener-corps.html' | relative_url }}) and the Resonance Stewardship Program treat these caverns as protected diplomatic archives rather than industrial resource sites.
